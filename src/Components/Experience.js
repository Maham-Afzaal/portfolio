...
{/* 2nd column */}
                ...
                <Box sx={{m:'2rem',alignItems:'center',display: 'flex',flexDirection: 'column',justifyContent: 'center',}} className='nn'>
                    <img src={Devicon} width='100px' height='100px'  sx={{marginBottom: '1rem',}}/>
                ...
                <Box>
                    ...
                    <Typography variant='body1' sx={{fontSize:'small'}}>I have extensive experience working as a front-end developer at Devicon, specializing in React.js and utilizing the Mui framework. My primary responsibility was converting various designs into fully functional websites that met the specific requirements of our clients. </Typography>
...
{/* 2nd column */}
                ...
                <Box sx={{m:'2rem',alignItems:'center',display: 'flex',flexDirection: 'column',justifyContent: 'center',}} className='Ts'>
                    <img src={T} width='100px' height='100px' mb='20px'/>
