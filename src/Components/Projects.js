        ...
        <div>
          <Grid container spacing={2}>
              ...
              >
                <CardActionArea>
                  ...
                  <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      A to-do list that helps individuals or teams keep track of
                      tasks and activities they need to complete.
                    </Typography>
                  </CardContent>
                  <Divider
                    sx={{
              ...
              >
                <CardActionArea>
                  ...
                  <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      A Web App where enables Universal Communication among
                      Individuals.
                    </Typography>
                  </CardContent>
                  <Divider
              ...
              >
                <CardActionArea>
                  ...
                  <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      An marketplace connecting pet buyers and sellers
                      worldwide, offering a wide range of pet breeds for sale.
                    </Typography>
                  </CardContent>
                  <Divider
                    sx={{
            ...
            <Grid item lg={4} md={6} sm={12}>
              <Card
                component="a"
                href="https://github.com/Maham-Afzaal/bman"
                target="_blank"
                sx={{
                  textDecoration: "none",
                  boxShadow: "0 0 10px #e0e0e0",
              ...
              >
                <CardActionArea>
                  ...
                  <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      A webpage that displays the serives of BMan providers.A
                      client requested designed based web page.
                    </Typography>
                  </CardContent>
                  <Divider
                    sx={{
              ...
              >
                <CardActionArea>
                  ...
                  <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      We provide the full spectrum of renewable energy concepts
                      from a single source. As a leading full-service provider,
                  ...
                  >
                    ...
                    <Button
                      component="a"
                      href="https://energy-lb.vercel.app"
                      target="_blank"
                      variant="contained"
                    >
                      Live Demo
              ...
              >
                <CardActionArea>
                  ...
                  <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      A blog post Static Site where any article, news piece, or
                      guide that's published section of a website.
                    </Typography>
                  </CardContent>
                  <Divider
                    sx={{
            ...
            <Grid item lg={4} md={6} sm={12}>
              <Card
                component="a"
                href="https://github.com/Maham-Afzaal/petco"
                target="_blank"
                sx={{
                  textDecoration: "none",
                  boxShadow: "0 0 10px #e0e0e0",
